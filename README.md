...
I added voronoi tiling based opalescence shader on the same gaussian integration foundations, and the results are pretty damn interesting, and it opens a lot of doors. We had to fix a lot of things from the shadertoy sample to make it more customizable. The results speak for themselves. 
